...
string getTimeInItaly() {
    ...
    if (curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_CAINFO, "C:/Users/toute/Documents/School/CIT/CIT 66 - C++ Programing/Daily CPP/11-19 chatBot01/include");
...
int main() {
    string apiKey = "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";
    string userMessage;
